package EuroStandardBank.EuroStandardBankCrawler;
...
public class App 
{
    public static void main( String[] args ) throws IOException
    {
    	...
    	DBCollection collection = database.getCollection("Valuti");
    	 ...
    	 org.jsoup.nodes.Document doc = Jsoup.connect("http://eurostandard.com.mk/kursna/html/kursna.html").get();
        ...
        
         {
             ...
             if(flag==0) {
             	...
             	flag=1;//prviot pat elseto ne go gleda
...
//                 }
         ...
         jsonMsg = jsonMsg.substring(0, jsonMsg.length()-4);
         jsonMsg = jsonMsg + "]";
